...
describe("agent-grant-routes", () => {
  ...
  it("GET returns AGENT_DOMAIN_GRANT history newest first", async () => {
    ...
    expect(scopes).toContain("ptds.chat");
    rmSync(dir, { recursive: true, force: true });
  });
