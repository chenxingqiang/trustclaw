...
import { executePersonalWrite } from "../../../trustclaw/tra/personal-write.js";

export type TrustclawTraWriteToolDeps = {
...
export function createTrustclawTraWriteToolFactory(
  pluginConfig: TrustclawPluginConfig | undefined,
  deps: TrustclawTraWriteToolDeps,
) {
