...
- Panel **C**: chat — use **`trustclaw_tra_query`** for NRDL / reimbursement questions
...
2. Never invent NRDL payment rules; use **`trustclaw_tra_query`** when the trust runtime is mounted.
