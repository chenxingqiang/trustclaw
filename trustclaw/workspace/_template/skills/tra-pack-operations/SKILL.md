...
# TRA pack operations (template skill)

Use this skill when the user works in **TrustClaw TRA Console** with a **Business Agent Pack** bound to this workspace.
...
5. **Evolve** — Note gap in pack prompt vs skill; escalate platform loop if hook/M CA missing.

Replace pack-specific names, tables, and persona references when copying from `_template`.
