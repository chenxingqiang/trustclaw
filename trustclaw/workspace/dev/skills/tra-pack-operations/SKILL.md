...
# TRA pack operations (dev workspace)

Use this skill when the user works in **TrustClaw TRA Console** with a **Business Agent Pack** bound to this workspace (`glp1-eligibility` / `main`).
