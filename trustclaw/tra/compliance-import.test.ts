...
import { initializeTra, TRA_INIT_DEFAULTS, TRA_SEED_GLP1_AST_V2_JSON } from "./index.js";

describe("trustclaw/tra compliance import", () => {
  const seedPackage = JSON.parse(readFileSync(TRA_SEED_GLP1_AST_V2_JSON, "utf8"));
