...
import { TRA_SEED_NRDL_REFERENCE_GLP1_JSON } from "./paths.js";
import {
...
describe("trustclaw/tra reference sync", () => {
  const seedPackage = JSON.parse(readFileSync(TRA_SEED_NRDL_REFERENCE_GLP1_JSON, "utf8"));
