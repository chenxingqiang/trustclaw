...
import { TRA_TABLE_CATALOG, type TraSubscriptionType } from "./table-catalog.js";
...
function countTableRows(db: ReturnType<typeof openTraDatabase>, table: string): number {
...
export function getBrowseSubscriptionSnapshot(
  ...
  try {
    ...
    for (const [table, entry] of Object.entries(TRA_TABLE_CATALOG)) {
