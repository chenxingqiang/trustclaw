...
describe("trustclaw-tra-bridge", () => {
  it("exports the TRA tool names used by the plugin", () => {
    expect(TRUSTCLAW_TRA_QUERY_TOOL).toBe("trustclaw_tra_query");
    expect(TRUSTCLAW_TRA_WRITE_TOOL).toBe("trustclaw_tra_write");
  });
